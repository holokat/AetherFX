...
- Parameters are passed as plain JSON values; curves are [[t, v], ...] with t in 0..1, gradients are [[t, [r, g, b, a]], ...]. Keyframe tracks are set with set_keyframe.
...
- Projectile / missile: a small mesh sphere core (radius 0.06-0.12, emissive 4-8) whose position is keyframed with set_keyframe; emitters, trail and light use `parent` = the core id, emitters use inherit_velocity 0.2-0.3.
