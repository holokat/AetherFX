...
PREFILL: dict[str, dict[str, list[Any]]] = {
    'campfire': {
        'ps_flame_body': [
            [21, [0.025, 0.997, -0.077], 1.434, 0.195, 11.7, 0.49, 0.257, [[0.22, 0.17, -0.13], [-0.01, 0.17, -0.14], [0.1, 0.2, -0.06], [-0.08, 0.21, -0.17], [0.0, 0.24, -0.2], [-0.27, 0.25, 0.02], [0.01, 0.34, 0.24], [0.12, 0.37, -0.25], [0.09, 0.36, 0.09], [0.12, 0.37, -0.04], [0.14, 0.48, 0.03], [0.15, 0.44, -0.1], [-0.15, 0.56, 0.23], [0.16, 0.42, 0.08], [-0.05, 0.59, -0.32], [-0.14, 0.53, 0.06], [0.04, 0.5, -0.01], [0.06, 0.54, 0.13], [0.2, 0.48, 0.11], [0.06, 0.54, -0.22], [-0.1, 0.7, -0.3]]],
            [12, [-0.177, 0.984, -0.015], 1.256, 0.268, 14.3, 0.171, 0.129, [[0.07, 0.56, 0.08], [0.08, 0.67, 0.05], [-0.05, 0.69, -0.18], [-0.26, 0.8, 0.14], [0.27, 0.69, 0.13], [-0.25, 0.93, 0.33], [0.24, 0.86, 0.02], [-0.04, 0.87, -0.34], [-0.15, 0.8, 0.06], [0.2, 0.65, 0.12], [-0.28, 0.91, 0.14], [0.13, 0.66, -0.07]]],
        ],
        'ps_flame_tongue': [
            [8, [0.009, 1.0, 0.03], 2.015, 0.578, 15.3, 0.376, 0.154, [[0.1, 0.34, 0.05], [-0.19, 0.4, 0.1], [0.18, 0.44, -0.08], [-0.04, 0.44, 0.18], [-0.0, 0.48, 0.07], [0.08, 0.45, -0.3], [-0.16, 0.66, -0.14], [-0.15, 0.88, -0.13]]],
            [9, [0.006, 0.999, -0.044], 1.859, 0.261, 14.5, 0.119, 0.128, [[-0.15, 0.66, -0.08], [0.2, 0.68, -0.22], [0.29, 0.92, 0.15], [-0.23, 0.7, 0.09], [-0.01, 1.09, -0.19], [0.19, 1.41, -0.23], [-0.34, 1.02, 0.17], [0.01, 1.67, -0.08], [-0.32, 1.75, 0.21]]],
        ],
        'ps_flame_lick': [
            [18, [-0.037, 0.996, -0.077], 0.811, 0.22, 14.2, 0.204, 0.195, [[0.06, 0.06, -0.24], [0.23, 0.08, -0.09], [-0.07, 0.1, -0.21], [-0.14, 0.09, 0.15], [-0.2, 0.11, 0.13], [0.26, 0.13, -0.03], [0.22, 0.12, -0.08], [0.16, 0.2, -0.07], [-0.04, 0.19, 0.24], [0.18, 0.22, -0.12], [0.06, 0.26, -0.2], [0.05, 0.26, 0.25], [-0.11, 0.34, -0.24], [0.01, 0.26, -0.22], [0.16, 0.31, 0.13], [-0.13, 0.35, 0.18], [-0.28, 0.3, -0.17], [0.19, 0.32, 0.17]]],
        ],
        'ps_coal_glow': [
    ...
    'campfire_smolder': {
        'ps_flame_body': [
            [8, [-0.281, 0.946, 0.159], 0.597, 0.182, 17.8, 0.562, 0.261, [[-0.04, 0.07, 0.01], [-0.03, 0.11, -0.16], [0.04, 0.13, -0.08], [0.21, 0.12, 0.1], [0.17, 0.13, -0.07], [-0.18, 0.18, -0.15], [-0.0, 0.32, 0.24], [0.06, 0.23, -0.25]]],
            [9, [-0.23, 0.908, 0.35], 0.491, 0.222, 35.6, 0.129, 0.081, [[0.1, 0.16, -0.12], [-0.14, 0.34, 0.18], [-0.09, 0.38, 0.19], [-0.05, 0.49, 0.2], [0.09, 0.26, 0.11], [0.07, 0.34, 0.11], [-0.06, 0.37, 0.04], [-0.28, 0.2, 0.09], [0.05, 0.56, 0.2]]],
        ],
        'ps_flame_tongue': [
            [4, [-0.093, 0.981, 0.17], 0.758, 0.047, 11.1, 0.411, 0.18, [[-0.08, 0.15, 0.23], [0.13, 0.19, -0.06], [-0.02, 0.24, 0.19], [-0.05, 0.39, -0.2]]],
            [3, [0.102, 0.995, -0.014], 0.945, 0.248, 9.0, 0.05, 0.104, [[0.09, 0.24, 0.23], [-0.15, 0.45, 0.14], [0.09, 0.55, 0.09]]],
        ],
        'ps_flame_lick': [
            [9, [-0.228, 0.954, 0.197], 0.404, 0.166, 33.9, 0.171, 0.2, [[0.25, 0.05, -0.04], [-0.13, 0.1, 0.18], [-0.11, 0.09, -0.25], [0.1, 0.13, -0.18], [0.2, 0.13, -0.04], [-0.2, 0.13, 0.2], [0.13, 0.2, 0.26], [0.15, 0.23, 0.24], [-0.07, 0.19, -0.28]]],
        ],
        'ps_coal_glow': [
    ...
    'campfire_low': {
        'ps_flame_body': [
            [12, [-0.124, 0.989, -0.079], 0.815, 0.117, 13.5, 0.471, 0.19, [[0.21, 0.11, 0.08], [0.13, 0.13, -0.05], [0.06, 0.15, -0.08], [-0.08, 0.16, 0.09], [-0.19, 0.23, -0.22], [-0.1, 0.23, 0.1], [-0.23, 0.22, -0.15], [-0.14, 0.26, 0.07], [-0.15, 0.28, -0.07], [-0.09, 0.35, -0.15], [0.18, 0.42, -0.12], [0.06, 0.49, -0.15]]],
            [9, [-0.076, 0.997, -0.013], 0.744, 0.306, 26.7, 0.224, 0.163, [[-0.2, 0.26, 0.27], [0.08, 0.26, 0.09], [-0.12, 0.48, -0.14], [-0.02, 0.59, -0.13], [-0.1, 0.61, 0.03], [0.24, 0.48, 0.09], [0.0, 0.51, 0.19], [-0.11, 0.64, -0.08], [-0.08, 0.28, 0.41]]],
        ],
        'ps_flame_tongue': [
            [6, [0.07, 0.996, 0.049], 1.176, 0.279, 14.0, 0.345, 0.168, [[0.18, 0.23, -0.06], [0.15, 0.28, -0.18], [0.05, 0.27, -0.23], [0.04, 0.42, 0.21], [-0.05, 0.43, 0.29], [0.23, 0.75, 0.27]]],
            [6, [-0.016, 0.998, -0.06], 1.085, 0.236, 20.4, 0.136, 0.134, [[-0.05, 0.33, 0.21], [0.02, 0.55, -0.04], [0.31, 0.98, 0.11], [-0.11, 0.64, 0.1], [0.22, 0.92, -0.03], [-0.08, 1.03, -0.3]]],
        ],
        'ps_flame_lick': [
            [11, [-0.076, 0.963, -0.257], 0.508, 0.214, 14.5, 0.191, 0.154, [[-0.18, 0.05, -0.11], [0.1, 0.06, -0.22], [-0.17, 0.07, -0.17], [0.23, 0.1, 0.05], [-0.22, 0.09, -0.05], [-0.14, 0.19, -0.2], [0.09, 0.19, -0.23], [-0.19, 0.16, -0.03], [-0.17, 0.15, -0.21], [-0.22, 0.19, -0.02], [0.15, 0.37, -0.05]]],
        ],
        'ps_coal_glow': [
    ...
    'campfire_high': {
        'ps_flame_body': [
            [18, [0.015, 1.0, 0.007], 2.263, 0.398, 10.1, 0.501, 0.22, [[-0.07, 0.25, 0.1], [-0.11, 0.31, -0.07], [0.13, 0.33, -0.14], [-0.19, 0.39, 0.05], [0.06, 0.38, -0.06], [0.11, 0.48, -0.08], [-0.13, 0.39, 0.24], [-0.26, 0.52, 0.1], [0.04, 0.64, -0.14], [0.13, 0.68, -0.06], [-0.07, 0.54, -0.03], [0.22, 0.54, 0.08], [-0.07, 0.82, -0.13], [-0.15, 0.61, -0.22], [0.28, 0.75, 0.1], [0.16, 0.92, -0.03], [0.01, 0.91, -0.01], [-0.17, 0.91, -0.18]]],
            [15, [-0.12, 0.988, -0.094], 1.751, 0.287, 7.0, 0.16, 0.187, [[-0.01, 0.69, -0.04], [0.15, 1.07, -0.15], [-0.16, 0.97, 0.14], [-0.18, 0.78, 0.14], [0.08, 1.0, -0.2], [-0.3, 1.14, -0.06], [0.0, 1.32, -0.15], [-0.31, 0.98, 0.07], [-0.42, 1.08, 0.09], [-0.04, 1.22, 0.11], [-0.3, 1.19, -0.21], [0.19, 1.18, -0.13], [-0.23, 1.3, -0.05], [-0.2, 1.62, -0.17], [0.15, 1.72, 0.09]]],
        ],
        'ps_flame_tongue': [
            [9, [-0.054, 0.996, 0.065], 2.782, 0.598, 13.1, 0.386, 0.158, [[0.02, 0.5, 0.16], [0.04, 0.56, -0.11], [0.01, 0.66, 0.27], [0.06, 0.81, 0.31], [-0.12, 0.72, -0.2], [0.18, 0.96, -0.16], [-0.0, 0.94, 0.28], [0.09, 1.09, 0.18], [-0.28, 0.93, -0.09]]],
            [6, [-0.117, 0.992, -0.057], 2.806, 0.468, 11.7, 0.126, 0.103, [[-0.09, 1.33, -0.05], [-0.29, 1.43, 0.2], [-0.06, 1.31, -0.2], [-0.29, 1.53, -0.24], [0.15, 1.37, 0.19], [-0.07, 2.39, -0.3]]],
        ],
        'ps_flame_lick': [
            [17, [-0.099, 0.993, -0.059], 1.237, 0.192, 12.0, 0.197, 0.195, [[0.05, 0.06, 0.24], [-0.09, 0.08, -0.22], [-0.2, 0.11, -0.14], [-0.12, 0.15, 0.21], [-0.1, 0.16, -0.22], [-0.03, 0.17, -0.23], [-0.21, 0.25, -0.03], [-0.16, 0.23, -0.15], [-0.13, 0.23, 0.14], [-0.21, 0.25, -0.08], [-0.06, 0.33, -0.21], [-0.03, 0.39, 0.16], [-0.23, 0.43, -0.07], [0.21, 0.37, -0.21], [-0.25, 0.42, 0.07], [-0.03, 0.5, 0.19], [0.05, 0.6, -0.08]]],
        ],
        'ps_coal_glow': [
    ...
    'campfire_dying': {
        'ps_flame_body': [
            [1, [0.473, 0.848, 0.238], 0.477, 0.0, 0.0, 0.372, 0.0, [[-0.15, 0.11, 0.13]]],
            [1, [-0.445, 0.871, -0.208], 0.321, 0.0, 0.0, 0.013, 0.0, [[0.03, 0.27, -0.2]]],
        ],
        'ps_flame_tongue': [
            None,
            [1, [-0.213, 0.878, -0.428], 1.347, 0.0, 0.0, 0.004, 0.0, [[0.24, 0.38, -0.09]]],
        ],
        'ps_flame_lick': [
            [2, [0.443, 0.884, 0.147], 0.552, 0.235, 31.1, 0.103, 0.156, [[0.2, 0.12, -0.08], [0.03, 0.27, 0.27]]],
        ],
        'ps_coal_glow': [
...
def build(slug: str, spec: dict[str, Any], prefill: bool = True) -> dict[str, Any]:
    ...
    nodes += [
        ...
        node("f_buoy_fire", "force", {"force_type": "buoyancy", "strength": r4(2.4 * fh)}),
        node("f_curl_fire", "force", {"force_type": "curl_noise", "strength": 0.95, "frequency": 1.2, "octaves": 3,
                                      "speed": 1.2}),
    ...
    nodes.append(emitter("e_flame_body", "ps_flame_body", "wind_flame", "flames",
                         animated(periodic(breath, 46.0 * fr)),
                         shape="disc", radius=r4(BED_RADIUS * 0.62), position=[0.0, r4(0.14 * fh), 0.0],
                         direction=[0.0, 1.0, 0.0], spread=14.0, velocity=r4(1.55 * fh),
                         velocity_variance=r4(0.6 * fh)))
    ...
    nodes.append(emitter("e_flame_tongue", "ps_flame_tongue", "wind_flame", "flames",
                         animated(periodic([(0.3, 2, 1.4), (0.2, 5, 0.3), (0.15, 9, 2.2)], 26.0 * fr)),
                         shape="disc", radius=r4(BED_RADIUS * 0.6), position=[0.0, r4(0.3 * fh), 0.0],
                         direction=[0.0, 1.0, 0.0], spread=22.0, velocity=r4(2.1 * fh),
                         velocity_variance=r4(1.1 * fh)))
    ...
    nodes.append(emitter("e_flame_lick", "ps_flame_lick", "wind_flame", "flames",
                         animated(periodic(lick_breath, 44.0 * max(fr, 0.1))),
                         ...
                         velocity=r4(0.8 * max(fh, 0.5)), velocity_variance=0.35))
