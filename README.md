...
New and still being polished: Shield Buff (standard, ice, fire and poison, each in a basic and a rune style), Life Drain, Corruption Drain and Soul Drain (each as a flowing stream, a thin beam and a thick volumetric beam), Homing Arcane Missile, Chain Lightning, Meteor, Meteor Shower, Flame Wave, Frost Nova, Blink, Sword Strike, Lantern Light, Ambient Energy, Power Up (default, arcane, nature, void, fire and ice), Bandage (nature, holy, arcane and void), Level Up, Resurrect, Chimney Smoke, Campfire (smolder, low, medium, high and dying) and Fire Torch (wall, brazier, standing and handheld).
